...
$query=$conn->prepare("insert into db.`tenent` (name,email,dob,address,city,state,pincode,phone,p_id,roomno,occupancy_date,deposit) values (:name,:email,:dob,:address,:city,:state,:pincode,:phone,:p_id,:roomno,:occupancy_date,:deposit)");	   
